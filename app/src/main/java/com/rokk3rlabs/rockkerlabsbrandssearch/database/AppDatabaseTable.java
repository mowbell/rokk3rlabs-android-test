...
public class AppDatabaseTable {
    ...
    public static class DatabaseOpenHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            mDatabase.execSQL("INSERT INTO "+FTS_VIRTUAL_TABLE_BRAND+ " ("+COL_NAME+") VALUES ('Gap'),('Banana Republic'),('Boss'),('Hugo Boss'),('Taylor'),('Rebecca Taylor')");
            ...
            mDatabase.execSQL("INSERT INTO "+FTS_VIRTUAL_TABLE_CLOTHING+ " ("+COL_NAME+") VALUES ('Denim'),('Pants'),('Sweaters'),('Skirts'),('Dresses')");
        }
